...
public:
    ...
    QRange(double xmin, double xmax, double ymin, double ymax, double zmin, double zmax);
...
public:
    ...
    void setShowCoordinate(bool value)  { mShowCoordinate = value; }
...
private:
    ...
    QRange mRange;
    Axis  mAxis;
    bool mAdjustPlaneView, mShowPlane, mShowGrid, mShowAxis, mShowLabel, mShowAxisBox, mShowCoordinate;
...
public slots:
    ...
    void setAdjustPlaneView(bool value) {
        mXAxis.setAdjustPlaneView(value);
        mYAxis.setAdjustPlaneView(value), mZAxis.setAdjustPlaneView(value);
    }
...
protected:
    ...
    void renderTextAtWorldCoordinates(const QVector3D& vec, QString string, QFont font = QFont("Helvetica"), QColor color = QColor(Qt::black));
    void renderTextAtScreenCoordinates(int x, int y, QString string, QFont font = QFont("Helvetica"), QColor color = QColor(Qt::black));
